                ...
                <div class="swiper productSmall">
                    <div class="swiper-wrapper">
                        <div class="card mb-5 swiper-slide">
                            <img src="{{ asset('assets/images/product/img-25.png') }}"
                                class="img-fluid d-flex mx-auto h-100 cursor-pointer" />
                        </div>
                        <div class="card mb-5 swiper-slide">
                            <img src="{{ asset('assets/images/product/img-26.png') }}"
                                class="img-fluid d-flex mx-auto h-100 cursor-pointer" />
                        </div>
                        <div class="card mb-5 swiper-slide">
                            <img src="{{ asset('assets/images/product/img-27.png') }}"
                                class="img-fluid d-flex mx-auto h-100 cursor-pointer" />
                        </div>
                        <div class="card mb-5 swiper-slide">
                            <img src="{{ asset('assets/images/product/img-28.png') }}"
                                class="img-fluid d-flex mx-auto h-100 cursor-pointer" />
                        </div>
                        <div class="card swiper-slide">
                            <img src="{{ asset('assets/images/product/img-29.png') }}"
                                class="img-fluid d-flex mx-auto h-100 cursor-pointer" />
                        </div>
                    </div>
                </div>
                                ...
                                <div class="swiper-slide product">
                                    <div>
                                        <img class="drift-demo-trigger img-fluid w-100"
                                            src="{{ asset('assets/images/product/img-25.png') }}">
                                    </div>
                                </div>
                                <div class="swiper-slide product">
                                    <div>
                                        <img class="drift-demo-trigger img-fluid w-100"
                                            src="{{ asset('assets/images/product/img-26.png') }}">
                                    </div>
                                </div>
                                <div class="swiper-slide product">
                                    <div>
                                        <img class="drift-demo-trigger img-fluid w-100"
                                            src="{{ asset('assets/images/product/img-27.png') }}">
                                    </div>
                                </div>
                                <div class="swiper-slide product">
                                    <div>
                                        <img class="drift-demo-trigger img-fluid w-100"
                                            src="{{ asset('assets/images/product/img-28.png') }}">
                                    </div>
                                </div>
                                <div class="swiper-slide product">
                                    <div>
                                        <img class="drift-demo-trigger img-fluid w-100"
                                            src="{{ asset('assets/images/product/img-29.png') }}">
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            <div class="products-review-images d-flex">
                                                                ...
                                                                <a href="javascript:voide(0)" data-discover="true">
                                                                    <img src="{{ asset('assets/images/product/img-03.png') }}"
                                                                        class="avatar-lg" alt="Product Image">
                                                                </a>
                                                            </div>
                                                        </div>
