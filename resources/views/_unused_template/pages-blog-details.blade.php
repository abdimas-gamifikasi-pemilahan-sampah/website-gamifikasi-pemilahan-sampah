            ...
            <div class="col-12 col-xl-4">
                <div class="blog-details-list mb-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap gap-4">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/images/small/img-10.jpg') }}" alt="Image"
                                        class="img-fluid avatar-3xl object-fit-cover rounded-2"></a>
                                <a href="javascript:void(0)"><img src="{{ asset('assets/images/small/img-12.jpg') }}" alt="Image"
                                        class="img-fluid avatar-3xl object-fit-cover rounded-2"></a>
                                <a href="javascript:void(0)"><img src="{{ asset('assets/images/small/img-11.jpg') }}" alt="Image"
                                        class="img-fluid avatar-3xl object-fit-cover rounded-2"></a>
                                <a href="javascript:void(0)"><img src="{{ asset('assets/images/small/img-13.jpg') }}" alt="Image"
                                        class="img-fluid avatar-3xl object-fit-cover rounded-2"></a>
                                <a href="javascript:void(0)"><img src="{{ asset('assets/images/small/img-14.jpg') }}" alt="Image"
                                        class="img-fluid avatar-3xl object-fit-cover rounded-2"></a>
                                <a href="javascript:void(0)"><img src="{{ asset('assets/images/small/img-4.jpg') }}" alt="Image"
                                        class="img-fluid avatar-3xl object-fit-cover rounded-2"></a>
                                <a href="javascript:void(0)"><img src="{{ asset('assets/images/small/img-2.jpg') }}" alt="Image"
                                        class="img-fluid avatar-3xl object-fit-cover rounded-2"></a>
                                <a href="javascript:void(0)"><img src="{{ asset('assets/images/small/img-3.jpg') }}" alt="Image"
                                        class="img-fluid avatar-3xl object-fit-cover rounded-2"></a>
                            </div>
                        </div>
                    </div>
