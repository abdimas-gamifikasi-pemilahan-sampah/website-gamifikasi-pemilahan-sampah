                            ...
                            <table class="table text-nowrap align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" alt="Avatar Image"
                                                class="avatar-md rounded-pill">
                                            <div>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <div class="h-32px w-32px p-1 bg-light-subtle rounded">
                                                    <img src="{{ asset('assets/images/auth/logo-7.png') }}" alt="Logo Image"
                                                        class="img-fluid">
                                                </div>
                                                Skyline Innovations
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <div class="h-32px w-32px p-1 bg-light-subtle rounded">
                                                    <img src="{{ asset('assets/images/auth/logo-8.png') }}" alt="Logo Image"
                                                        class="img-fluid">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <div class="h-32px w-32px p-1 bg-light-subtle rounded">
                                                    <img src="{{ asset('assets/images/auth/logo-9.png') }}" alt="Logo Image"
                                                        class="img-fluid">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <div class="h-32px w-32px p-1 bg-light-subtle rounded">
                                                    <img src="{{ asset('assets/images/auth/logo-10.png') }}" alt="Logo Image"
                                                        class="img-fluid">
                                                </div>
                                                TechNova Solutions
                                            </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex flex-column align-items-center justify-content-center p-3 rounded">
                                        <div class="position-relative">
                                            <img id="avatarPreview" src="{{ asset('assets/images/avatar/15.jpg') }}"
                                                alt="Avatar Preview"
...
@section('js')
    ...
    <!-- File Js -->
    <script src="{{ asset('assets/js/app/crm-contact.init.js') }}"></script>
    <!-- App js -->
