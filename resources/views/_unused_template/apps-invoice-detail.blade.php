                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-5 border-bottom border-dashed py-4">
                            ...
                            <div class="col-md-3 text-end">
                                ...
                                <img src="{{ asset('assets/images/apps/qr-code.svg') }}" alt="QR Code" class="h-144px w-144px">
                            </div>
                        </div>
                        <div class="py-4">
                            <div class="mt-4">
                        ...
                        <div class="pt-8">
                            <img src="{{ asset('assets/images/apps/signature.png') }}" alt="Signature" class="h-50px">
