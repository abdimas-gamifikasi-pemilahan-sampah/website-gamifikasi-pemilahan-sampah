                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="pills-finish" role="tabpanel"
                                    ...
                                    <div class="text-center mx-auto w-384px p-5 rounded shadow-lg mt-6">
                                        <div class="mb-4">
                                            <img src="{{ asset('assets/images/e-commerce/successfull.png') }}" width="150"
                            ...
                            <table class="table text-nowrap table-borderless border rounded">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="avatar-lg bg-light rounded p-1">
                                                <img src="{{ asset('assets/images/product/img-08.png') }}" alt="Product Image"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="avatar-lg bg-light rounded p-1">
                                                <img src="{{ asset('assets/images/product/img-07.png') }}" alt="Product Image"
                                                    class="img-fluid d-block">
                                            </div>
                                        </td>
                                        <td>
