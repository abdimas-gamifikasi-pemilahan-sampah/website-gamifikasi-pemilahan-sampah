                ...
                <div class="row">
                    <div class="col-md-6 col-xxl-12">
                        <div class="card overflow-hidden position-relative">
                            <img src="{{ asset('assets/images/apps/rose-petals-info.svg') }}" alt="Rose Petas Image"
                    ...
                    <div class="col-md-6 col-xxl-12">
                        <div class="card card-h-100 bg-danger-subtle border-0 overflow-hidden">
                            <div class="card-body">
                                ...
                                <img src="{{ asset('assets/images/apps/alaram-clock.png') }}" alt="alaram-clock Image"
...
@section('js')
    ...
    <!-- File js -->
    <script src="{{ asset('assets/js/app/academy-single-category.init.js') }}"></script>
    <!-- App js -->
