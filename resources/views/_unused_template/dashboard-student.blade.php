                            ...
                            <div class="card-body p-0">
                                <div class="row">
                                    ...
                                    <div class="col-4 d-none d-md-block">
                                        <img src="{{ asset('assets/images/apps/students-vector.png') }}" alt="Students"
                ...
                <div class="card card-h-100">
                    <div class="card-body">
                        <div class="d-flex gap-3 align-items-center">
                            <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Student"
...
@section('js')
    ...
    <!-- File js -->
    <script src="{{ asset('assets/js/app/academy-user-student.init.js') }}"></script>
    <!-- App js -->
