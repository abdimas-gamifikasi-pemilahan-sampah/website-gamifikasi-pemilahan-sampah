                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center gap-4 mb-8">
                            <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Avatar Image" class="avatar-lg rounded">
                            <div class="flex-grow-1">
                    ...
                    <div class="card-body">
                        <table class="table align-middle">
                            <tbody>
                                ...
                                <tr>
                                    <td class="w-50px"><img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Avatar Image"
                                            class="avatar-md rounded"></td>
                                    <td>
                                ...
                                <tr>
                                    <td class="w-50px"><img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Avatar Image"
                                            class="avatar-md rounded"></td>
                                    <td>
...
@section('js')
    ...
    <script src="{{ asset('assets/js/app/project-overview.init.js') }}"></script>
