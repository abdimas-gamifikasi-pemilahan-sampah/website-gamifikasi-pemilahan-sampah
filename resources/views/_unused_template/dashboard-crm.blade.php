                            ...
                            <div class="card-body">
                                <div class="d-flex flex-md-row flex-column align-items-center">
                                    ...
                                    <div class="vector-image ms-md-auto text-center">
                                        <img src="{{ asset('assets/images/dashboard/welcome.png') }}" alt="CRM Vector"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <section class="toplead-height px-5 mx-n5" data-simplebar style="height: 395px;">
                            ...
                            <div class="pb-3 mb-3 border-bottom d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Json Taylor"
                                        class="rounded-circle me-2" width="40" height="40">
                                    <div>
                            ...
                            <div class="pb-3 mb-3 border-bottom d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Suzika Stallone"
                                        class="rounded-circle me-2" width="40" height="40">
                                    <div>
                            ...
                            <div class="pb-3 mb-3 border-bottom d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" alt="Selena Deoyl"
                                        class="rounded-circle me-2" width="40" height="40">
                                    <div>
                                        <strong>Selena Deoyl</strong>
                                        <p class="mb-0 text-muted fs-12">selenadeoyl114@gmail.com</p>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/images/avatar/avatar-9.jpg') }}" alt="Sophia Carter"
                                        class="rounded-circle me-2" width="40" height="40">
                                    <div>
                            ...
                            <table class="table text-nowrap table-striped align-middle">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <div class="h-32px w-32px p-1 bg-light-subtle rounded">
                                                    <img src="{{ asset('assets/images/auth/logo-1.png') }}" alt="Logo Image"
                                                        class="img-fluid">
                                                </div>
                                                BluePeak Digital
                                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3 fw-medium">
                                                <img src="{{ asset('assets/images/avatar/avatar-9.jpg') }}" alt="Avatar Image"
                                                    class="avatar-md rounded-pill">
                                                Beta Solutions
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <div class="h-32px w-32px p-1 bg-light-subtle rounded">
                                                    <img src="{{ asset('assets/images/auth/logo-2.png') }}" alt="Logo Image"
                                                        class="img-fluid">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <div class="h-32px w-32px p-1 bg-light-subtle rounded">
                                                    <img src="{{ asset('assets/images/auth/logo-3.png') }}" alt="Logo Image"
                                                        class="img-fluid">
                                                </div>
                                                NextGen Ventures
                                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3 fw-medium">
                                                <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Avatar Image"
                                                    class="avatar-md rounded-pill">
                                                Delta Media
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <div class="h-32px w-32px p-1 bg-light-subtle rounded">
                                                    <img src="{{ asset('assets/images/auth/logo-4.png') }}" alt="Logo Image"
                                                        class="img-fluid">
                                                </div>
                                                CyberCore Labs
                                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3 fw-medium">
                                                <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Avatar Image"
                                                    class="avatar-md rounded-pill">
                                                Juno Wraith
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <div class="h-32px w-32px p-1 bg-light-subtle rounded">
                                                    <img src="{{ asset('assets/images/auth/logo-5.png') }}" alt="Logo Image"
                                                        class="img-fluid">
                                                </div>
                                                LumenTech Systems
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <div class="h-32px w-32px p-1 bg-light-subtle rounded">
                                                    <img src="{{ asset('assets/images/auth/logo-6.png') }}" alt="Logo Image"
                                                        class="img-fluid">
                                                </div>
                                                Peak Industries
                                            </div>
                        ...
                        <div class="border p-4 rounded" data-simplebar style="height: 182px;">
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-3 mb-4">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('assets/images/avatar/avatar-11.jpg') }}" alt="John Doe"
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-3 mb-4">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('assets/images/avatar/avatar-12.jpg') }}" alt="Emily Smith"
                                        class="rounded avatar-md">
                                    <div>
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-3 mb-4">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Michael Brown"
                                        class="rounded avatar-md">
                                    <div>
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-3 mb-4">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Sarah Johnson"
                                        class="rounded avatar-md">
                                    <div>
