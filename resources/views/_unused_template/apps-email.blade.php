                ...
                <div class="message-list-content" data-simplebar>
                    <ul class="message-list" id="mail-list">
                        ...
                        <li
                            ...
                            <div class="avatar-item avatar-md">
                                <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-2.jpg') }}"
                                    alt="avatar image">
                            </div>
                        ...
                        <li
                            ...
                            <div class="avatar-item avatar-md">
                                <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-3.jpg') }}"
                                    alt="avatar image">
                            </div>
                        ...
                        <li
                            ...
                            <div class="avatar-item avatar-md">
                                <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-7.jpg') }}"
                                    alt="avatar image">
                            </div>
                        ...
                        <li
                            ...
                            <div class="avatar-item avatar-md">
                                <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-9.jpg') }}"
                                    alt="avatar image">
                            </div>
                        ...
                        <li
                            ...
                            <div class="avatar-item avatar-md">
                                <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-11.jpg') }}"
                                    alt="avatar image">
                            </div>
                        ...
                        <li
                            ...
                            <div class="avatar-item avatar-md">
                                <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-12.jpg') }}"
                                    alt="avatar image">
                            </div>
