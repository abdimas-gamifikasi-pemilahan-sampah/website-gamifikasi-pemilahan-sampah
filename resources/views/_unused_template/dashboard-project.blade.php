                ...
                <div class="card overflow-hidden upgrade-card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <img src="{{ asset('assets/images/dashboard/upgrade-img.png') }}" alt="Upgrade Image"
                                class="position-absolute top-50 translate-middle-y end-0 w-200px">
                            <img src="{{ asset('assets/images/dashboard/circle.png') }}" alt="Circle Image"
...
@section('js')
    ...
    <!-- File js -->
    <script src="{{ asset('assets/js/dashboard/project.init.js') }}"></script>
    <!-- App js -->
