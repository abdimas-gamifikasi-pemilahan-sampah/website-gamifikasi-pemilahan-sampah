                            ...
                            <table class="table text-nowrap table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/images/flag/gb.svg') }}" alt="Flag Image" class="w-30px">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/images/flag/ca.svg') }}" alt="Flag Image" class="w-30px">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/images/flag/au.svg') }}" alt="Flag Image" class="w-30px">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <section class="px-5 mx-n5" data-simplebar style="height: 360px;">
                            ...
                            <div class="d-flex align-items-start mb-6">
                                <img src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" class="avatar-md rounded-circle me-3"
                                    alt="User">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-start">
                                <img src="{{ asset('assets/images/avatar/avatar-9.jpg') }}" class="avatar-md rounded-circle me-3"
                                    alt="User">
                                <div class="flex-grow-1">
