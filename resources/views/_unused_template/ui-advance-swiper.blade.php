                    ...
                    <div class="card-body">
                        ...
                        <div dir="ltr" class="swiper default-swiper rounded">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/small/img-4.jpg') }}" alt="Image"
                                        class="img-fluid object-fit-cover h-100" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/small/img-5.jpg') }}" alt="Image"
                                        class="img-fluid object-fit-cover h-100" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/small/img-6.jpg') }}" alt="Image"
                                        class="img-fluid object-fit-cover h-100" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div dir="ltr" class="swiper navigation-swiper rounded">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/small/img-7.jpg') }}" alt="Image"
                                        class="img-fluid object-fit-cover h-100" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/small/img-8.jpg') }}" alt="Image"
                                        class="img-fluid object-fit-cover h-100" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/small/img-9.jpg') }}" alt="Image"
                                        class="img-fluid object-fit-cover h-100" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/small/img-10.jpg') }}" alt="Image"
                                        class="img-fluid object-fit-cover h-100" />
                                </div>
                            </div>
                ...
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div dir="ltr" class="swiper pagination-dynamic-swiper rounded">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/small/img-11.jpg') }}" alt="Image"
                                        class="img-fluid object-fit-cover h-100" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/small/img-12.jpg') }}" alt="Image"
                                        class="img-fluid object-fit-cover h-100" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/small/img-13.jpg') }}" alt="Image"
                                        class="img-fluid object-fit-cover h-100" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/images/small/img-1.jpg') }}" alt="Image"
