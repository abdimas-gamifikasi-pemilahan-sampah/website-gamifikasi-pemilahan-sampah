            ...
            <div class="justify-content-center align-items-center min-vh-100 row gy-0">
                <div class="col-lg-8">
                    <div class="position-relative text-center">
                        <img class="min-h-320px img-fluid" src="{{ asset('assets/images/vector/offline.svg') }}" alt="Vector Image">
...
@section('js')
    ...
    <script type="module" src="{{ asset('assets/js/auth/coming-soon.init.js') }}"></script>
@endsection
