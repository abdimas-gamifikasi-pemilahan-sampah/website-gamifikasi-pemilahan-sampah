                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-box table-responsive">
                            <table class="table text-nowrap align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>The Importance of Responsive Web Design</td>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>SEO Basics: How to Rank Higher on Google</td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Top 5 CMS Platforms for Website Management</td>
                                        <td><span class="badge bg-light text-muted">Published</span></td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Why Website Speed Matters for User Experience</td>
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>Content Marketing Trends to Watch in 2025</td>
                                        <td><span class="badge bg-light text-muted">Published</span></td>
                                        <td><span class="badge bg-success-subtle text-success">Public</span></td>
                                        <td>10 Feb 2025</td>
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td>Why Internal Linking is Important for SEO</td>
                                        <td><span class="badge bg-light text-muted">Draft</span></td>
                                        <td><span class="badge bg-warning-subtle text-warning">Private</span></td>
                                        <td>15 Feb 2025</td>
                        ...
                        <div class="d-flex flex-wrap align-items-center mt-5">
                            <div class="fw-medium"> Showing 1 - 6 of 3 Entries </div>
                            <div class="ms-auto">
...
@section('js')
    ...
    <!-- File js -->
    <script src="{{ asset('assets/js/app/academy-cms-blog.init.js') }}"></script>
    <!-- App js -->
