                        ...
                        <div id="b1">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-3 my-5">
                                        <img src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" alt="Zara Lume"
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-3 my-5">
                                        <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Zara Lume"
                                            class="avatar-md rounded-pill">
                                        <div>
                                            <h6 class="mb-1">Dax Zeno</h6>
                        ...
                        <div id="b2">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-3 my-5">
                                        <img src="{{ asset('assets/images/avatar/avatar-9.jpg') }}" alt="Zara Lume"
                                            class="avatar-md rounded-pill">
                                        <div>
                                            <h6 class="mb-1">Dax Zeno</h6>
                        ...
                        <div id="b3">
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-3 my-5">
                                        <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Zara Lume"
                                            class="avatar-md rounded-pill">
                                        <div>
                                            <h6 class="mb-1">Acme Corp</h6>
...
@section('js')
    ...
    <!-- File Js -->
    <script src="{{ asset('assets/js/app/crm-deal.init.js') }}"></script>
    <!-- App js -->
