                                        ...
                                        <td>
                                            <div class="d-flex gap-3 align-items-center">
                                                <div
                                                    ...
                                                    <img src="{{ asset('assets/images/e-commerce/crop-top.png') }}" alt="Product Image"
                                                        class="img-fluid">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex gap-3 align-items-center">
                                                <div
                                                    class="h-56px w-56px d-flex justify-content-center align-items-center p-1 bg-light-subtle rounded">
                                                    <img src="{{ asset('assets/images/e-commerce/watch.png') }}" alt="Product Image"
                                                        class="img-fluid">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex gap-3 align-items-center">
                                                <div
                                                    class="h-56px w-56px d-flex justify-content-center align-items-center p-1 bg-light-subtle rounded">
                                                    <img src="{{ asset('assets/images/e-commerce/shoes.png') }}" alt="Product Image"
                                                        class="img-fluid">
                                                </div>
                                                <div>
