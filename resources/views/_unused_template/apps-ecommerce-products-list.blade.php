                        ...
                        <table id="default_datatable" class="table table-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/images/product/img-06.png') }}"
                                                class="avatar-lg border rounded-1 p-1" alt="Product Image">
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/images/product/img-07.png') }}"
                                                class="avatar-lg border rounded-1 p-1" alt="Product Image">
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/images/product/img-08.png') }}"
                                                class="avatar-lg border rounded-1 p-1" alt="Product Image">
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/images/product/img-09.png') }}"
                                                class="avatar-lg border rounded-1 p-1" alt="Product Image">
                                            <div>
                                                <h6 class="mb-0">Mens T-shirt</h6>
                                                <small class="text-muted">Cotton fabric </small>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/images/product/img-10.png') }}"
                                                class="avatar-lg border rounded-1 p-1" alt="Product Image">
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/images/product/img-11.png') }}"
                                                class="avatar-lg border rounded-1 p-1" alt="Product Image">
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/images/product/img-12.png') }}"
                                                class="avatar-lg border rounded-1 p-1" alt="Product Image">
                                            <div>
