                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center gap-4 mb-5">
                            <img src="{{ asset('assets/images/flag/ad.svg') }}" alt="Product Image" class="avatar-md">
                            <div class="w-100">
                        ...
                        <div class="d-flex align-items-center gap-4 mb-5">
                            <img src="{{ asset('assets/images/flag/af.svg') }}" alt="Product Image" class="avatar-md">
                            <div class="w-100">
                                <div class="d-flex justify-content-between align-items-center fs-13">
                        ...
                        <div class="d-flex align-items-center gap-4 mb-5">
                            <img src="{{ asset('assets/images/flag/ag.svg') }}" alt="Product Image" class="avatar-md">
                            <div class="w-100">
                                <div class="d-flex justify-content-between align-items-center fs-13">
                        ...
                        <div class="d-flex align-items-center gap-4 mb-5">
                            <img src="{{ asset('assets/images/flag/ar.svg') }}" alt="Product Image" class="avatar-md">
                            <div class="w-100">
                                <div class="d-flex justify-content-between align-items-center fs-13">
                        ...
                        <div class="d-flex align-items-center gap-4 mb-5">
                            <img src="{{ asset('assets/images/flag/al.svg') }}" alt="Product Image" class="avatar-md">
                            <div class="w-100">
                                <div class="d-flex justify-content-between align-items-center fs-13">
                        ...
                        <div class="d-flex align-items-center gap-4 mb-5">
                            <img src="{{ asset('assets/images/flag/aw.svg') }}" alt="Product Image" class="avatar-md">
                            <div class="w-100">
                                <div class="d-flex justify-content-between align-items-center fs-13">
                        ...
                        <div class="d-flex align-items-center gap-4">
                            <img src="{{ asset('assets/images/flag/at.svg') }}" alt="Product Image" class="avatar-md">
                            <div class="w-100">
                                <div class="d-flex justify-content-between align-items-center fs-13">
                                    <p class="text-muted mb-1">Aruba</p>
                                    <div class="d-flex fw-semibold align-items-center gap-2">
                    ...
                    <div class="col-xl-6">
                        <div class="card overflow-hidden card-h-100">
                            ...
                            <div class="card-body">
                                ...
                                <img src="{{ asset('assets/images/dashboard/truck.png') }}" alt="Truck Image"
...
@section('js')
    ...
    <!-- File js -->
    <script src="{{ asset('assets/js/dashboard/logistic.init.js') }}"></script>
    <!-- App js -->
