                            ...
                            <div class="col-12 col-md-6 col-xl-4 col-xxl-3">
                                <div class="card">
                                    <div class="card-body pt-4">
                                        ...
                                        <div class="rounded-3">
                                            <img src="{{ asset('assets/images/e-commerce/crop-top.png') }}"
                            ...
                            <div class="col-12 col-md-6 col-xl-4 col-xxl-3">
                                <div class="card">
                                    <div class="card-body pt-4">
                                        ...
                                        <div class="rounded-3">
                                            <img src="{{ asset('assets/images/e-commerce/watch.png') }}"
                            ...
                            <div class="col-12 col-md-6 col-xl-4 col-xxl-3">
                                <div class="card">
                                    <div class="card-body pt-4">
                                        ...
                                        <div class="rounded-3">
                                            <img src="{{ asset('assets/images/e-commerce/purse.png') }}"
                                                class="img-fluid h-256px w-256px mx-auto d-block p-5"
                                                alt="Red Nike Shoes">
                                        </div>
                                        <div class="text-center">
                            ...
                            <div class="col-12 col-md-6 col-xl-4 col-xxl-3">
                                <div class="card">
                                    <div class="card-body pt-4">
                                        ...
                                        <div class="rounded-3">
                                            <img src="{{ asset('assets/images/e-commerce/shoes.png') }}"
                                                class="img-fluid h-256px w-256px mx-auto d-block p-5"
                                                alt="Red Nike Shoes">
                                        </div>
                                        <div class="text-center">
                            ...
                            <div class="col-12 col-md-6 col-xl-4 col-xxl-3">
                                <div class="card">
                                    <div class="card-body pt-4">
                                        ...
                                        <div class="rounded-3">
                                            <img src="{{ asset('assets/images/e-commerce/chair.png') }}"
                                                class="img-fluid h-256px w-256px mx-auto d-block p-5"
                                                alt="Red Nike Shoes">
                                        </div>
                                        <div class="text-center">
