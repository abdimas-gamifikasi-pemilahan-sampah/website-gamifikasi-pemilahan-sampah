                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="card card-h-100 addGradient text-white">
                        <div class="card-body p-0 position-relative">
                            ...
                            <img src="{{ asset('assets/images/apps/vector.jpg') }}" alt="Vector Image" class="img-fluid w-75 addImg">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-5">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body p-3">
                            <div class="position-relative">
                                <img src="{{ asset('assets/images/apps/react.jpg') }}" alt="Course Image"
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body p-3">
                            <div class="position-relative">
                                <img src="{{ asset('assets/images/apps/css.jpg') }}" alt="Course Image"
                                    class="img-fluid rounded-2 h-208px w-full object-fit-cover">
                                <div
                                    class="position-absolute top-0 start-0 mt-2 ms-2 d-flex gap-1 justify-content-center align-items-lg-center">
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body p-3">
                            <div class="position-relative">
                                <img src="{{ asset('assets/images/apps/full-stack.png') }}" alt="Course Image"
                                    class="img-fluid rounded-2 h-208px w-full object-fit-cover">
                                <div
                                    class="position-absolute top-0 start-0 mt-2 ms-2 d-flex gap-1 justify-content-center align-items-lg-center">
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body p-3">
                            <div class="position-relative">
                                <img src="{{ asset('assets/images/apps/javascript.png') }}" alt="Course Image"
                                    class="img-fluid rounded-2 h-208px w-full object-fit-cover">
                                <div
                                    class="position-absolute top-0 start-0 mt-2 ms-2 d-flex gap-1 justify-content-center align-items-lg-center">
            ...
            <div class="row mb-5">
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body p-3">
                            <div class="position-relative">
                                <img src="{{ asset('assets/images/apps/data-analysis.jpg') }}" alt="Course Image"
                                    class="img-fluid rounded-2 h-208px w-full object-fit-cover">
                                <div
                                    class="position-absolute top-0 start-0 mt-2 ms-2 d-flex gap-1 justify-content-center align-items-lg-center">
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body p-3">
                            <div class="position-relative">
                                <img src="{{ asset('assets/images/apps/machine-learning.jpg') }}" alt="Course Image"
                                    class="img-fluid rounded-2 h-208px w-full object-fit-cover">
                                <div
                                    class="position-absolute top-0 start-0 mt-2 ms-2 d-flex gap-1 justify-content-center align-items-lg-center">
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body p-3">
                            <div class="position-relative">
                                <img src="{{ asset('assets/images/apps/deep-learning.jpg') }}" alt="Course Image"
                                    class="img-fluid rounded-2 h-208px w-full object-fit-cover">
                                <div
                                    class="position-absolute top-0 start-0 mt-2 ms-2 d-flex gap-1 justify-content-center align-items-lg-center">
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body p-3">
                            <div class="position-relative">
                                <img src="{{ asset('assets/images/apps/fundamental.jpg') }}" alt="Course Image"
                                    class="img-fluid rounded-2 h-208px w-full object-fit-cover">
                                <div
                                    class="position-absolute top-0 start-0 mt-2 ms-2 d-flex gap-1 justify-content-center align-items-lg-center">
            ...
            <div class="row">
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body p-3">
                            <div class="position-relative">
                                <img src="{{ asset('assets/images/apps/python.jpg') }}" alt="Course Image"
                                    class="img-fluid rounded-2 h-208px w-full object-fit-cover">
                                <div
                                    class="position-absolute top-0 start-0 mt-2 ms-2 d-flex gap-1 justify-content-center align-items-lg-center">
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body p-3">
                            <div class="position-relative">
                                <img src="{{ asset('assets/images/apps/NLP.png') }}" alt="Course Image"
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body p-3">
                            <div class="position-relative">
                                <img src="{{ asset('assets/images/apps/robotic.jpg') }}" alt="Course Image"
                                    class="img-fluid rounded-2 h-208px w-full object-fit-cover">
                                <div
                                    class="position-absolute top-0 start-0 mt-2 ms-2 d-flex gap-1 justify-content-center align-items-lg-center">
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body p-3">
                            <div class="position-relative">
                                <img src="{{ asset('assets/images/apps/AI.jpeg') }}" alt="Course Image"
                                    class="img-fluid rounded-2 h-208px w-full object-fit-cover">
                                <div
                                    class="position-absolute top-0 start-0 mt-2 ms-2 d-flex gap-1 justify-content-center align-items-lg-center">
...
@section('js')
    ...
    <!-- File js -->
    <script src="{{ asset('assets/js/app/academy-list.init.js') }}"></script>
@endsection
