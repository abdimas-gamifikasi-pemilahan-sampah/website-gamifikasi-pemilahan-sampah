                ...
                <div class="card card-h-100">
                    ...
                    <div class="card-body position-relative">
                        ...
                        <div class="d-flex align-items-end justify-content-between">
                            ...
                            <img src="{{ asset('assets/images/dashboard/student.png') }}" class="img-fluid w-160px animation-bounce"
                                alt="Live Session">
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush list-borderless">
                            ...
                            <li class="list-group-item d-flex justify-content-between py-3">
                                <div class="d-flex gap-3">
                                    <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Instructor"
                                        class="avatar-md rounded-circle">
                                    <div>
                            ...
                            <li class="list-group-item d-flex justify-content-between py-3">
                                <div class="d-flex gap-3">
                                    <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Instructor"
                                        class="avatar-md rounded-circle">
                                    <div>
