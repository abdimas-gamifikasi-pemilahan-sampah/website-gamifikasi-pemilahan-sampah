...
document.addEventListener("DOMContentLoaded", () => {
    /**
     * Reusable function to render chart safely
     */
    const renderChart = (selector, seriesData, color) => {
    ...
    // Render charts only if container exists
    renderChart("#chart-1", [20, 45, 40, 64, 35, 25, 35], "#52cc99");
    renderChart("#chart-2", [10, 25, 30, 54, 45, 39, 15], "#ff6647");
    renderChart("#chart-3", [15, 20, 10, 45, 20, 10, 5], "#52cc99");
    renderChart("#chart-4", [3, 5, 7, 11, 8, 5, 7], "#ff6647");
});
